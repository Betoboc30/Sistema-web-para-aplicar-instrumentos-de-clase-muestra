...
<body>
		...
		if ($date < 12) { ?>
			...
			<div class="card-img-overlay">
				<div class="card-img-overlay text-center">
					...
					<h5 class="card-title text-center fs-4">Coordinador(a)</h5>
				</div>
			</div>
	...
	<div class="row m-3 mb-1 border bg-light justify-content-center ">
		...
		<div class="col-12 col-lg-10 card-group ">
			<div class="card mt-3 ms-5 me-5 mb-3">
				<img src="../imagenes/agendar.jpg" class="card-img-top" alt="...">
				<div class="card-body">
					<h5 class="card-title">Agendar clase</h5>
				</div>
				<div class="card-footer d-flex align-items-center justify-content-between bg-transparent">

					<a class="small  stretched-link" data-bs-toggle="modal" data-bs-target="#exampleModal">Ir</a>
					<div class="small "><i class="bi bi-caret-right-fill"></i></div>

				</div>
			</div>
			<div class="card mt-3 ms-5 me-5 mb-3">
				<img src="../imagenes/guia.jpg" class="card-img-top" alt="...">
				<div class="card-body">
					<h5 class="card-title">Ver próximas clases</h5>
				</div>
				<div class="card-footer d-flex align-items-center justify-content-between bg-transparent">

					<a class="small  stretched-link" href="aplicarGuia.php">Ir</a>
					<div class="small "><i class="bi bi-caret-right-fill"></i></div>

				</div>
			</div>
			<div class="card mt-3 ms-5 me-5 mb-3">
				<img src="../imagenes/perfil.jpg" class="card-img-top" alt="...">
				<div class="card-body">
					<h5 class="card-title">Ver Perfil</h5>
				</div>
				<div class="card-footer d-flex align-items-center justify-content-between bg-transparent">

					<a class="small  stretched-link" href="perfil.php">Ir</a>
					<div class="small "><i class="bi bi-caret-right-fill"></i></div>
