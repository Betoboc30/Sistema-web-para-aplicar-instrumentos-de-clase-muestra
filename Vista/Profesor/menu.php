	...
	<div class="container-fluid ms-5">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item">
					<a class="nav-link" aria-current="page" href="resultados.php">Resultados</a>
				</li>
			</ul>
			...
			<div class="modal-body">
				<form class="row g-3 needs-validation mt-2" method="POST"
					...
					<div class="input-group input-group-sm mb-3 has-validation">
						...
						<input type="datetime-local" name="fechaAgenda" class="form-control" aria-label="Sizing example input"
