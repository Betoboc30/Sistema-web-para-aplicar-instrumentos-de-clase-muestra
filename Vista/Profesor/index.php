		...
		if ($date < 12) { ?>
			...
			<div class="card-img-overlay">
				<div class="card-img-overlay text-center">
					...
					<h5 class="card-title text-center fs-4">Profesor(a)</h5>
				</div>
			</div>
	...
	<div class="row m-3 mb-1 border bg-light justify-content-center ">
		...
		<div class="col-9 card-group ">
			...
			<div class="card mt-3 ms-5 me-5 mb-3">
				<img src="../imagenes/resultado.jpg" class="card-img-top" alt="...">
				<div class="card-body">
					<h5 class="card-title">Resultados</h5>
				</div>
				<div class="card-footer d-flex align-items-center justify-content-between bg-transparent">

					<a class="small  stretched-link" href="resultados.php">Ir</a>
