...
<body>
    ...
    <div class="m-0 vh-100 row justify-content-center align-items-center">
        <div class="card" style="max-width: 750px; padding-left: 0;">
            <div class="row g-0">
                <div class="col-5">
                    <img src="../imagenes/gradiente.jpg" class="img-fluid rounded-start" style="height: 100%;">
                    <div class="card-img-overlay col-5 text-center mt-2 text-white">

                        <div class="position-relative">
                            <img src="../../Public/<?= $consulta->fotoperfil ?>"
                                style="width:130px; height: 130px; object-fit: cover;" class="rounded-circle mb-2"><br>
    ...
    <?php $consultaDocumento = $conexion->query("SELECT * FROM datoscontrato WHERE idUsuario = $id");
    $datosDocs = $consultaDocumento->fetch_object();
    ?>
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form enctype="multipart/form-data" action="../../Controlador/Profesor/editarArchivos.php"
                        ...
                        <div class="input-group input-group-sm mb-3 has-validation">
                            ...
                            <button class="btn btn-outline-info" type="button" data-bs-toggle="modal"
                                data-bs-target="#visualizar" onclick="verDocumento('<?php echo $datosDocs->CV ?>')">Ver
                                documento</button>
                            <button class="btn btn-outline-success" name="btnCV" type="submit">Editar</button>
                    ...
                    <form enctype="multipart/form-data" action="../../Controlador/Profesor/editarArchivos.php"
                        ...
                        <input type="hidden" name="idUsuario" value="<?= $id ?>" readonly>
                        <div class="input-group input-group-sm mb-3 has-validation">
                            <label class="input-group-text" for="inputGroupFile02">Identificación con fotografía
                                (INE/Pasaporte)</label>
                            <input type="file" name="identificacion" id="inputGroupFile02" class="form-control"
                                aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" required>
                            <button class="btn btn-outline-info" type="button" data-bs-toggle="modal"
                                data-bs-target="#visualizar"
                                onclick="verDocumento('<?php echo $datosDocs->Identificacion ?>')">Ver
                                documento</button>
                            <button class="btn btn-outline-success" name="btnIdentificacion"
                    ...
                    <form enctype="multipart/form-data" action="../../Controlador/Profesor/editarArchivos.php"
                        ...
                        <div class="input-group input-group-sm mb-3 has-validation">
                            ...
                            <button class="btn btn-outline-info" type="button" data-bs-toggle="modal"
                                data-bs-target="#visualizar"
                                onclick="verDocumento('<?php echo $datosDocs->CompDomicilio ?>')">Ver
                                documento</button>
                            <button class="btn btn-outline-success" name="btnComprobante" type="submit">Editar</button>
                        </div>
                    </form>
                    ...
                    <form enctype="multipart/form-data" action="../../Controlador/Profesor/editarArchivos.php"
                        ...
                        <div class="input-group input-group-sm mb-3 has-validation">
                            ...
                            <button class="btn btn-outline-info" type="button" data-bs-toggle="modal"
                                data-bs-target="#visualizar"
                                onclick="verDocumento('<?php echo $datosDocs->TituloAcad ?>')">Ver
                                documento</button>
                            <button class="btn btn-outline-success" name="btnTitulo" type="submit">Editar</button>
                        </div>
                    </form>
                    ...
                    <form enctype="multipart/form-data" action="../../Controlador/Profesor/editarArchivos.php"
                        ...
                        <div class="input-group input-group-sm mb-3 has-validation">
                            ...
                            <button class="btn btn-outline-info" type="button" data-bs-toggle="modal"
                                data-bs-target="#visualizar"
                                onclick="verDocumento('<?php echo $datosDocs->Cedula ?>')">Ver
                                documento</button>
                            <button class="btn btn-outline-success" name="btnCedula" type="submit">Editar</button>
                        </div>
                    </form>
                    ...
                    <form enctype="multipart/form-data" action="../../Controlador/Profesor/editarArchivos.php"
                        ...
                        <div class="input-group input-group-sm mb-3 has-validation">
                            ...
                            <button class="btn btn-outline-info" type="button" data-bs-toggle="modal"
                                data-bs-target="#visualizar"
                                onclick="verDocumento('<?php echo $datosDocs->ActaNaci ?>')">Ver
                                documento</button>
                            <button class="btn btn-outline-success" name="btnActaNacimiento"
                                type="submit">Editar</button>
                        </div>
                    </form>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row g-3 needs-validation mt-2" method="POST"
                        ...
                        <div class="col">
                            <img src="../../Public/<?= $consulta->Firma ?>" width="100px"
                                class="rounded-circle mb-2 text-center"><br>
                        </div>
                        <div class="modal-footer">
