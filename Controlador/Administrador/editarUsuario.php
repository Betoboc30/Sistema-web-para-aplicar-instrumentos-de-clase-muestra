...
if (
    ...
    if ($tipo == 'Administrador') {
        $sql = $conexion->query("UPDATE usuario SET Nombre='$nombre',ApellidoP='$paterno',ApellidoM='$materno',FechaNac='$nacimiento',GradoA='$grado',Correo='$correo',Contrasena='$pass' WHERE idUsuario = $idUsuario");
    } else {
        ...
        if ($tipo == 'Coordinador') {
            ...
            if (isset($_POST['cargo']) && isset($_POST['academia']) && $firma != "") {
                ...
                $sql = $conexion->query("UPDATE usuario SET Nombre='$nombre',ApellidoP='$paterno',ApellidoM='$materno',FechaNac='$nacimiento',GradoA='$grado',Correo='$correo',Contrasena='$pass', Firma='$firma', Cargo='$cargo', idAcademia = $academia  WHERE idUsuario = $idUsuario");

            } elseif (isset($_POST['cargo']) && isset($_POST['academia']) && empty($firma)) {

                $sql = $conexion->query("UPDATE usuario SET Nombre='$nombre',ApellidoP='$paterno',ApellidoM='$materno',FechaNac='$nacimiento',GradoA='$grado',Correo='$correo',Contrasena='$pass', Cargo='$cargo', idAcademia = $academia  WHERE idUsuario = $idUsuario");
            }
            ...
            if ($firma != "") {
                ...
                $sql = $conexion->query("UPDATE usuario SET Nombre='$nombre',ApellidoP='$paterno',ApellidoM='$materno',FechaNac='$nacimiento',GradoA='$grado',Correo='$correo',Contrasena='$pass', Firma='$firma' WHERE idUsuario = $idUsuario");
